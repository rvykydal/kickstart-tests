...
function check_gui_configurations() {
    ...
    # " bond0.222:1484c12b-0f40-445b-93b4-10bef8ec6ce3 bond0:8df1c4f6-76aa-42e3-9fa9-aa1f00c155b4 enp0s5:None enp0s4:None enp0s3:d3b58e36-68cb-4de1-b1fc-98707045274f "
    local dev_cons=""
